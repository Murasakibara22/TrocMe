      ...
      <div class="row">
        ...
        <div class="row">
          ...
          <div class="mb-1 col-6">
                ...
                <!-- title -->
                <form action="{{ route('SearchfilterVen') }}">
          ...
          <div class="col" style="padding-right: 0.5%!important; margin-top: 1rem;">
            <div class="card card-product">
              <div class="card-body" style="padding: 4% 4%; ">
                ...
                <div class="text-small mb-1"><a href="/annonceDetailVentes/{{$annonces->slug}}" class="text-decoration-none text-muted"><small>{{$ville->libelle}}</small></a></div>
                @endforeach
                ...
                <div><a href="/annonceDetailVentes/{{$annonces->slug}}" class="btn btn-outline-primary btn-sm mt-2  align-items-center">
                     Achetez</a></div>
              </div>
            </div>
          </div>
