        ...
        <div class="col-12" >
          ...
          <div class="d-flex justify-content-between ps-md-8 ps-6"  style="background: url(../images/User/{{$user->bannear}} )no-repeat; background-size: cover; border-radius: ; background-position: center;">
            <div class="d-flex align-items-center">
              <h1 class="mb-0 fw-bold">Les Articles Recherchez de {{$user->nom}}</h1>

            </div>
            <div class="py-14">
              <div class="py-12 d-flex me-3">
  ...
  <section class="mt-2">
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <h6 class="mb-4 mt-4">Recherchez ou filtrez selon la Categorie</h6>
        <div class="row">
          <div class="mb-1 col-6 ">
           
            <!-- recherche -->
              <div class="app-search dropdown ">
                         <form action="{{ route('searchTroc') }}" >
          ...
          <div class="col">
            <div class="card card-product">
              <div class="card-body">
                ...
                <h2 class="fs-6 "><a href="/annonceDetail/{{$annonces->slug}}" class="text-inherit text-decoration-none">{{$annonces->titre}}</a></h2>
                </div>
                ...
                @if($annonces->type == "troque")
                     ...
                     <div><a href="/annonceDetail/{{$annonces->slug}}" class="btn btn-outline-warning btn-sm mt-2  align-items-center">
                     Achetez</a></div>
