                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Modifier une publicité<a href="/espaccepub_list" class="float-end"><button type="button" class="btn btn-outline-info rounded-pill ms-5"><i class="uil-circuit"></i> Liste des  publicitées</button> </a></h4>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="{{ route('modifyEspacePubs',$espace->slug) }}" method="POST" enctype="multipart/form-data">
                                        @csrf 
                                        @method('PUT')
                                              <div class="tab-content">
                                                  <div class="tab-pane show active" id="floating-preview">
                                                      <div class="row">
                                                          ...
                                                          <div class="col-lg-6">
                                                              ...
                                                              <div class="form-floating mb-3">
                                                                  <input type="text" name="titre" class="form-control" id="floatingInput" value="{{ old($espace->titre) ??  $espace->titre}}">
                                                                  <label for="floatingInput">titre de la publicité</label>
                                                              </div>
                                                      ...
                                                      <h5 class="mb-3 mt-4">Description</h5>
                                                              <div class="form-floating">
                                                                  <textarea class="form-control" name="description" value="{{ old($espace->description) ??  $espace->description}}" id="floatingTextarea"
                                                                      style="height: 100px">{{ old($espace->description) ??  $espace->description}}</textarea>
