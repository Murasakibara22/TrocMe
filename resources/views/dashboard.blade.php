                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col-6">
                                                <h5 class="text-muted fw-normal mt-0 text-truncate" title="Campaign Sent">Villes </h5>
                                                <h3 class="my-2 py-1">{{$villecount}}</h3>
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col-6">
                                                ...
                                                <h3 class="my-2 py-1">{{$annonceCount}}</h3>
                                                <p class="mb-0 text-muted">
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col-6">
                                                ...
                                                <h3 class="my-2 py-1">{{$souscatCount}}</h3>
                                                <p class="mb-0 text-muted">
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col-6">
                                                ...
                                                <h3 class="my-2 py-1">{{$payscount}}</h3>
                                                <p class="mb-0 text-muted">
                                    ...
                                    <div class="card-body pt-0">
                                        <div class="table-responsive">
                                            <table class="table table-striped table-sm table-nowrap table-centered mb-0">
                                                <thead>
                                                    <tr>
                                                        <th>Nom et prenoms utilisateurs</th>
                                                        <th>Nombre de vue du profile</th>
                                                        <th></th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    @if($user_more_view_profile && $user_more_view_profile->count() > 0)
                                                    @foreach($user_more_view_profile as $item)
                                                    <tr>
                                                        <td>
                                                            <h5 class="font-15 mb-1 fw-normal">{{$item->nom}} {{$item->prenom}}</h5>
                                                            <span class="text-muted font-13">Utilisateur</span>
                                                        </td>
                                                       
                                                        <td>{{$item->view_count_page}}</td>
                            ...
                            <div class="col-xl-4 col-lg-6">
                                <div class="card">
                                    ...
                                    <div class="card-body pt-2">
                                        ...
                                        @foreach($userAnnonce as $userAnnonces)
                                        @if( date('j M, Y', strtotime($userAnnonces->date))  == $today )

                                        <div class="d-flex align-items-start">
                                            <img class="me-3 rounded-circle" src="../images/User/{{$userAnnonces->image}}" width="40" alt="Troc moi images user">
                                            <div class="w-100 overflow-hidden">
                                                ...
                                                @endif
                                                <h5 class="mt-0 mb-1">{{$userAnnonces->nom}}</h5>
                                                <span class="font-13">{{$userAnnonces->email}}</span>
                                            </div>
