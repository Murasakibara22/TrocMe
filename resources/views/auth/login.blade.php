          ...
          <form action="{{ route('login') }}" method="POST">
            ...
            <div class="row g-3">
              ...
              <div class="d-flex justify-content-between">
                ...
                <div> Mot de passe Oublié ? <a href="../pages/forgot-password.html">Renitialiser</a></div>
              </div>
              <!-- btn -->
        ...
        <div class="col-lg-5 text-lg-start text-center mb-2 mb-lg-0">
          <ul class="list-inline mb-0">
            ...
            <li class="list-inline-item">
              <a href="#!"><img src="{{ asset('../assets/images/payment/amazonpay.svg') }}" alt=""></a>
            </li>
            <li class="list-inline-item">
              <a href="#!"><img src="{{ asset('../assets/images/payment/american-express.svg') }}" alt=""></a>
            </li>
            <li class="list-inline-item">
              <a href="#!"><img src="{{ asset('../assets/images/payment//mastercard.svg') }}" alt=""></a>
            </li>
            <li class="list-inline-item">
